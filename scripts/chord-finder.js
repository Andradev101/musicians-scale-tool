let userChooseNote = parseInt(prompt("Escolha uma nota: 0- C,1- C#,2- D,3- D#,4- E,5- F,6- F#,7- G,8- G#,9- A,10- A#,11- B"))
let majorChord = [repeatedNotes[userChooseNote],repeatedNotes[userChooseNote+4],repeatedNotes[userChooseNote+7]]
let minorChord = [repeatedNotes[userChooseNote],repeatedNotes[userChooseNote+3],repeatedNotes[userChooseNote+7]]
//chords formulas starting from the root to the end
